...
<div id="main">
    ...
    <br><h1 style="color:#0B0B61;">Enter Detail</h1><br><br>
        <fieldset><br><form method="post" action="cust_login1.php">
                <h2 style="color:#61210B;"><center>
                    PHONE NO.<input type="text" name="phnum" required/><br><br><br><br><br>
