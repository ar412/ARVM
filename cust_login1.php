...
$query = "select count(*),fname,phnum from customer where phnum=('$phnum') && password=('$password')" ;
...
mysql_close($conn);
	...
	<?php if($_SESSION['username']) { ?>
					<li><div style="color:#A9A9A9;font-size:28px;padding-top:40px;padding-left:10px" > <b>Welcome</b> <b><?php echo $_SESSION['username']; ?> </b></div></li> 
